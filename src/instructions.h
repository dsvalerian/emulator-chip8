...
static Instruction instructions[35] = {
    ...
    {"00EE", "RET", NULL, error_unhandled_instruction},                    // RET
    {"1nnn", "JP    L%03x", "JP    $%03x", jp},   // JP   addr
    {"2nnn", "CALL  L%03x", "CALL  $%03x", call},   // CALL addr
    {"3xkk", "SE    V%u, #%02x", NULL, error_unhandled_instruction},       // SE   Vx, byte
    {"4xkk", "SNE   V%u, #%02x", NULL, error_unhandled_instruction},       // SNE  Vx, byte
    {"5xy0", "SE    V%u, V%u", NULL, error_unhandled_instruction},         // SE   Vx, Vy
    {"6xkk", "LD    V%u, #%02x", NULL, error_unhandled_instruction},       // LD   Vx, byte
    {"7xkk", "ADD   V%u, #%02x", NULL, error_unhandled_instruction},       // ADD  Vx, byte
    {"8xy0", "LD    V%u, V%u", NULL, error_unhandled_instruction},         // LD   Vx, Vy
    ...
    {"Annn", "LD    I, $%03x", NULL, error_unhandled_instruction},         // LD   I, addr
    {"Bnnn", "JP    V0, $%03x", NULL, error_unhandled_instruction},        // JP   V0, addr
    {"Cxkk", "RND   V%u, #%02x", NULL, error_unhandled_instruction},       // RND  Vx, byte
    {"Dxyn", "DRW   V%u, V%u, #%02x", NULL, error_unhandled_instruction},  // DRW  Vx, Vy, nibble
